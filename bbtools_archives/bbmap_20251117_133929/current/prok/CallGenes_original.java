 ...
 *
 */
public class CallGenes_original extends ProkObject {
	...
	public static void main(String[] args){
		...
		CallGenes_original x=new CallGenes_original(args);
	 ...
	 * @param args Command line arguments
	 */
	public CallGenes_original(String[] args){
					...
					//Reads are processed in this block.
					{
						...
						if(vectorOut!=null && list!=null){
                            for(Orf orf : list){
								...
								float gcGene = CallGenes_original.gcRatio(geneSeq, 0, geneSeq.length - 1);
								...
								if (amino_features) {
									...
									if (seq) {
										...
										byte[] startWin = CallGenes_original.extractWindow(r1.bases, start, 18, 18);
										byte[] midWin = CallGenes_original.extractWindow(r1.bases, mid, 6, 6);
										byte[] stopWin = CallGenes_original.extractWindow(r1.bases, stop, 18, 18);
										...
										String oneHotStart = CallGenes_original.toOneHotString(startWin, 0, startWin.length-1);
										String oneHotMid = CallGenes_original.toOneHotString(midWin, 0, midWin.length-1);
										String oneHotStop = CallGenes_original.toOneHotString(stopWin, 0, stopWin.length-1);
