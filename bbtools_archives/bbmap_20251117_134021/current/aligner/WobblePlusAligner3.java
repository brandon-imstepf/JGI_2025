...
//			prevRowScore=maxScore; //Not needed
			...
			int posFromSimd=0;
			if(Shared.SIMD) {
				posFromSimd=shared.SIMDAlign.alignBandVectorAndReturnMaxPos(q, ref, bandStart, bandEnd, 
						prev, curr, MATCH, N_SCORE, SUB, INS);
			}else {
...
//			assert(!Shared.SIMD || maxPos==posFromSimd || 
//					((curr[maxPos])&SCORE_MASK)==((curr[posFromSimd])&SCORE_MASK)) : 
